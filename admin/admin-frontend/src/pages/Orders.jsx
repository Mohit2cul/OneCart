          ...
          {orders.map((order, index) => (
            ...
            >
              ...
              <div className="text-[15px] text-green-100">
                ...
                <p className="text-[20px] text-white leading-[30px]"> ₹ {order.amount}</p>
              </div>
              <select value={order.status} className="px-[5px] py-[10px] bg-slate-500 rounded-lg border-[1px] border-[#96eef3] font-medium shadow-lg hover:shadow-xl hover:bg-slate-800 transition-all duration-300 ease-in-out cursor-pointer" onChange={(e) => statusHandler(e ,order._id)}>
