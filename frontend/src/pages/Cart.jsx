...
return (
    <div className="w-full min-h-[100vh] overflow-x-hidden bg-gradient-to-l from-[#141414] to-[#0c2025]">
        <Navbar />
        <div className="h-[8%] w-full text-center pt-[80px]">
            <Title text1={"Your"} text2={"Cart"} />
        </div>
        <div className="w-full h-[92%] flex flex-wrap gap-[20px] p-[20px]">
